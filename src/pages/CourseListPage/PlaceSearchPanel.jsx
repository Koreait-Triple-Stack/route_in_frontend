...
export default function PlaceSearchPanel({ query, setQuery, results, loading, error, onSearch, onSelectResult }) {
    return (
        <Stack spacing={1.5}>
                    ...
                    <List dense disablePadding>
                        {results.map((r, idx) => (
                            <Box key={`${r.id ?? idx}-${r.x}-${r.y}`}>
                                <ListItemButton onClick={() => onSelectResult(r)}>
                                    <ListItemText
                                        primary={
                                        ...
                                        secondary={r.road_address_name || r.address_name || ""}
                                    />
                                </ListItemButton>
